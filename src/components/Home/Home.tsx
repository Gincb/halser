  ...
  return loading ? (
    ...
    <div className="home">
      <div className="home_authors">
        <h1 className="home_authors_title">Discover Authors</h1>
        <div className="home_authors_line"></div>
        <AuthorsList />
      </div>
      <div className="home_articles">
        <h1 className="home_articles_title">Recent Articles</h1>
        <div className="home_articles_line"></div>
