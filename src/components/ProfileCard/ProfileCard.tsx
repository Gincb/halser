  ...
  return (
    <section className='profile-card'>
      ...
      <article className='profile-card_description'>
        <p>A blog writer with a focus on lifestyle! I am interested in anything related to fashion and travel, and I try to incorporate these aspects in my articles.</p>
        <div className='profile-card_description_line'></div>
        <ul className='profile-card_description_socials'>
          <li><Email/><span>shomalin@email.com</span></li>
          <li><Instagram/><span>instagram.com/shomalin</span></li>
          <li><Twitter/><span>twitter.com/shomalin</span></li>
          <li><Linkedin/><span>linkedin.com/in/shomalin</span></li>
          <li><Webpage/><span>shomalin.com</span></li>
        </ul>
      </article>
    </section>
  )
